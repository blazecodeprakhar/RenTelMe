                ...
                {isSuperAdmin && (
                    <TabsContent value="team" className="space-y-6">
                        <Card>
                            ...
                            <CardContent>
                                <form onSubmit={handleCreateEmployee} className="grid sm:grid-cols-3 gap-4 items-end">
                                    <div className="grid gap-2">
                                    ...
                                    <div className="sm:col-span-3 lg:col-span-1 lg:col-start-4">
                                        {/* Placeholder for alignment */}
                                    </div>
                                    <Button type="submit" disabled={creatingEmployee} className="sm:col-span-3 w-full bg-primary hover:bg-primary/90 mt-2">
